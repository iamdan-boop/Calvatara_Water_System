<div>
    <div class="content-wrapper">
        ...
        <nav class="nav-item color">
            <input type="search" class="sear bg-light border-0 small" placeholder="Filter Search" aria-label="Search"
                aria-describedby="basic-addon2" wire:model="search">
            <!-- Main content -->
                                        ...
                                        @foreach ($clients as $client)
                                            <tr>
                                                ...
                                                <th class="money-bills">
                                                    <button class="eye"><a
                                                            href="{{ route('calculate.show', ['client' => $client->id]) }}"><i
                                                                class="fas fa-eye"></a></i></button>
                                                    <button class="bill-money"><a
                                                            href="{{ route('clientbills.show', ['client' => $client->id]) }}"><i
                                                                class="fas fa-money-bill"></i></a></button>
                                                </th>
                                            </tr>
                                        @endforeach
                                    </tbody>
