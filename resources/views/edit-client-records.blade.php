...
<div class="card shadow-b4">
    ...
    <form>
        ...
        <input type="hidden" name="editclient_id">
            ...
            <div class="form-group">
                <label>Email</label>
                <input type="ClientEmail" name="edit_ClientEmail" class="form-control checking_email" placeholder="Enter Email">
                <small class="error_email" style="color: red;"></small>
            </div>
    
            <div class="form-group">
                <label>ContactNumber</label>
                <input type="text" name="edit_ContactNumber"  class="form-control" placeholder="Enter ContactNumber">
            </div>
            <div class="form-group">
                <label>Route</label>
            ...
            <div class="form-group">
                ...
                <input type="text" name="edit_FirstMeterReading" class="form-control" placeholder="Enter FirstMeterReading">
            </div>
